UCR_SELECTION = ['ACSF1', 'BeetleFly', 'CBF', 'Coffee', 'CricketZ',
                 'DistalPhalanxOutlineCorrect', 'DodgerLoopWeekend',
                 'ECGFiveDays', 'EthanolLevel', 'FiftyWords', 'FreezerRegularTrain',
                 'GestureMidAirD2', 'GunPointMaleVersusFemale', 'Haptics', 'InsectEPGRegularTrain',
                 'LargeKitchenAppliances', 'Meat', 'MiddlePhalanxOutlineCorrect', 'MoteStrain',
                 'OSULeaf', 'PigArtPressure', 'ProximalPhalanxOutlineAgeGroup', 'Rock', 'SemgHandSubjectCh2',
                 'SmoothSubspace', 'Strawberry', 'ToeSegmentation1', 'TwoPatterns',
                 'UWaveGestureLibraryY', 'WordSynonyms']

UCR_NO_VARY= ['ACSF1', 'Adiac', 'ArrowHead', 'Beef', 'BeetleFly', 'BirdChicken', 'BME', 'Car', 'CBF', 'Chinatown',
